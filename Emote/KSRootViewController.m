...
-(void)loadMainNavigationStack
{
    ...
    [self transitionFromViewController:_rootViewController toViewController:mainNavigationController duration:0.65 options:UIViewAnimationOptionTransitionFlipFromTop animations:nil completion:nil];
}
